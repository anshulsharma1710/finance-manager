...
const SEED_USER_ID = "user_2ggLQwFRGVAXLdiMJPBve6TFuZ0";
...
const generateRandoAmount = (category: typeof categories.$inferInsert) => {
...
const generateTransactionsForDay = (day: Date) => {
    ...
    for(let i = 0; i < numTransactions; i++) {
        ...
        const amount = generateRandoAmount(category);
